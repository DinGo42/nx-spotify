...
export const Header = () => (
  <div className="sticky top-0 flex w-full items-center justify-between">
    <div className="flex gap-3">
      ...
      <Button styleType={"MAIN_ROUND"} className="rotate-180 hover:bg-black-200">
        <ArrowIcon />
      </Button>
    </div>
    <div className="flex gap-3">
      ...
      <Button styleType={"MAIN_ROUND"} className="relative size-8 overflow-hidden bg-white-800 p-0 hover:scale-105">
